...
Solo admin: `admin/credits`, `admin/invitations`, `admin/access-requests/[id]/invite`, `admin/orders/[id]`, `admin/orders/[id]/generate`, `admin/orders/[id]/color-model`, `admin/orders/[id]/edited-model`, `admin/order-statuses`, `admin/order-statuses/reorder`, `admin/order-statuses/[id]`, `admin/posts/[id]`, `GET /api/files/[id]`.

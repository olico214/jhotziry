...
Con sesión + CSRF (mutaciones) o solo sesión (lecturas): `orders`, `orders/[id]` (PATCH colores del 3D), `orders/[id]/messages`, `drafts`, `drafts/claim`, `posts` (POST), `posts/[id]/comments`, `posts/[id]/like`, `notifications`, `notifications/read`, `generate/text`, `generate/image`, `assistant/expand`, `quote`, `auth/logout`.
Solo admin: `admin/credits`, `admin/invitations`, `admin/access-requests/[id]/invite`, `admin/orders/[id]`, `admin/orders/[id]/generate`, `admin/order-statuses`, `admin/order-statuses/[id]`, `admin/posts/[id]`, `GET /api/files/[id]`.
